          ...
          >
            <Route path="account" element={<AccountLayout />}>
              ...
              <Route
                ...
                loader={orderHistoryRouteLoader}
              />
            </Route>
          </Route>
          <Route
            ...
            loader={() => productsRouteLoader(null)}
          />
          <Route
            path="food-set"
            element={<Menu heading="Сети" />}
            loader={() => productsRouteLoader(Categories.foodSet)}
          />
          <Route
            path="noodles"
            element={<Menu heading="Локшина" />}
            loader={() => productsRouteLoader(Categories.noodles)}
          />
          <Route
            path="roll"
            element={<Menu heading="Роли" />}
            loader={() => productsRouteLoader(Categories.roll)}
          />
          <Route
            path="pizza"
            element={<Menu heading="Піца" />}
            loader={() => productsRouteLoader(Categories.pizza)}
          />
          <Route
            path="cold-beverage"
            element={<Menu heading="Прохолодні напої" />}
            loader={() => productsRouteLoader(Categories.coldBeverage)}
          />
        ...
        >
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route
              ...
              loader={adminProductDetailsRouteLoader}
            />
            <Route path="products/create" element={<CreateProduct />} />
            <Route
              path="products/edit/:id"
              element={<EditProduct />}
              loader={adminEditProductRouteLoader}
            />
            <Route
              path="categories"
              element={<AdminCategories />}
              loader={adminCategoriesRouteLoader}
            />
            <Route
              path="categories/details/:id"
              element={<CategoryDetails />}
              loader={adminCategoryDetailsRouteLoader}
            />
            <Route path="categories/create" element={<CreateCategory />} />
            <Route
              path="categories/edit/:id"
              element={<EditCategory />}
              loader={adminEditCategoryRouteLoader}
            />
            <Route
              path="orders"
              element={<AdminOrders />}
              loader={adminOrdersRouteLoader}
            />
            <Route
              path="orders/details/:id"
              element={<OrderDetails />}
              loader={adminOrderDetailsRouteLoader}
            />
            <Route
              path="orders/edit/:id"
              element={<EditOrder />}
              loader={adminEditOrderRouteLoader}
            />
            <Route
              path="order-lines/details/:id"
              element={<OrderLineDetails />}
              loader={adminOrderLineDetailsRouteLoader}
            />
            <Route
              path="order-lines/create/order/:orderId"
              element={<CreateOrderLine />}
              loader={adminCreateOrderLineRouteLoader}
            />
            <Route
              path="order-lines/edit/:id"
              element={<EditOrderLine />}
              loader={adminEditOrderLineRouteLoader}
            />
            <Route
              path="users"
              element={<AdminUsers />}
              loader={adminUsersRouteLoader}
            />
            <Route
              path="users/details/:id"
              element={<UserDetails />}
              loader={adminUserDetailsRouteLoader}
            />
            <Route path="users/create" element={<CreateUser />} />
            <Route
              path="users/edit/:id"
              element={<EditUser />}
              loader={adminEditUserRouteLoader}
            />
            <Route
              path="shops"
              element={<AdminShops />}
              loader={adminShopsRouteLoader}
            />
            <Route
              path="shops/details/:id"
              element={<ShopDetails />}
              loader={adminShopDetailsRouteLoader}
            />
            <Route path="shops/create" element={<CreateShop />} />
            <Route
              path="shops/edit/:id"
              element={<EditShop />}
              loader={adminEditShopRouteLoader}
            />
          </Route>
        </Route>
      </Route>
